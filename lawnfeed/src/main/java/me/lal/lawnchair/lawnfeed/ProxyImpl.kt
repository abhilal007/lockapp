package me.lal.lawnchair.lawnfeed
...
import me.lal.lawnchair.launcherclient.LauncherClientProxyConnection
...
class ProxyImpl(val context: Context) : ILauncherClientProxy.Stub() {
    ...
    private val serviceIntent = getServiceIntent(context)
    ...
    override fun init(callback: ILauncherClientProxyCallback): Int {
        allowed = "me.lal.lawnchair" == callingPackage
        enforcePermission()
