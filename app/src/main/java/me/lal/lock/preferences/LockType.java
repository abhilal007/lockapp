package me.lal.lock.preferences;
    ...
    public static boolean isLockEnabled(Context context) {
        switch (LockType.getCurrent(context.getContentResolver())) {
            ...
            case PASSWORD_ALPHABETIC:
                Log.i("Yeah" , "Alpha Password");
            case PASSWORD_ALPHANUMERIC:
                Log.i("Yeah" , "Password AlphaNum");
            case PATTERN:
                Log.i("Yeah" , "Pattern");
            case FACE_WITH_PATTERN:
                Log.i("Yeah" , "Face Pattern");
            case FACE_WITH_PIN:
                Log.i("Yeah" , "Face Pin");
            case FACE_WITH_SOMETHING_ELSE:
                Log.i("Yeah" , "Face Else");
                return true;
