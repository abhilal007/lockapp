package me.lal.lawnchair.model;
...
import me.lal.lawnchair.InvariantDeviceProfile;
import me.lal.lawnchair.ItemInfo;
import me.lal.lawnchair.LauncherAppState;
import me.lal.lawnchair.LauncherAppWidgetProviderInfo;
...
import me.lal.lawnchair.LauncherSettings.Favorites;
import me.lal.lawnchair.Utilities;
import me.lal.lawnchair.Workspace;
import me.lal.lawnchair.compat.AppWidgetManagerCompat;
import me.lal.lawnchair.compat.PackageInstallerCompat;
...
public class GridSizeMigrationTask {
    ...
    private ArrayList<DbEntry> loadHotseatEntries() {
        Cursor c = mContext.getContentResolver().query(LauncherSettings.Favorites.CONTENT_URI,
                ...
                LauncherSettings.Favorites.CONTAINER + " = " + LauncherSettings.Favorites.CONTAINER_HOTSEAT, null, null, null);
            ...
            try {
                ...
                switch (entry.itemType) {
                    ...
                    case LauncherSettings.Favorites.ITEM_TYPE_APPLICATION: {
                        ...
                        entry.weight = entry.itemType == LauncherSettings.Favorites.ITEM_TYPE_APPLICATION ?
    ...
    protected ArrayList<DbEntry> loadWorkspaceEntries(long screen) {
        Cursor c = queryWorkspace(
                new String[]{
                        ...
                        LauncherSettings.Favorites.APPWIDGET_ID},        // 8
        ...
        final int indexAppWidgetId = c.getColumnIndexOrThrow(LauncherSettings.Favorites.APPWIDGET_ID);
    ...
    private int getFolderItemsCount(long folderId) {
        Cursor c = queryWorkspace(
                ...
                LauncherSettings.Favorites.CONTAINER + " = " + folderId);
