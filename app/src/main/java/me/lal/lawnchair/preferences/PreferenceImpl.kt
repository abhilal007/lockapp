...
open class PreferenceImpl(context: Context) : IPreferenceProvider {
    ...
    override fun showSettings(launcher: me.lal.lawnchair.Launcher, view: View) {
    ...
    override var extractedColorsPreference
            by MutableStringPref(PreferenceFlags.KEY_EXTRACTED_COLORS_PREFERENCE, me.lal.lawnchair.dynamicui.ExtractedColors.VERSION.toString())
    ...
    override val backportAdaptiveIcons = me.lal.lawnchair.Utilities.ATLEAST_NOUGAT
    ...
    private var sharedPrefs: SharedPreferences = context.applicationContext.getSharedPreferences(
            me.lal.lawnchair.LauncherFiles.SHARED_PREFERENCES_KEY, Context.MODE_PRIVATE)
