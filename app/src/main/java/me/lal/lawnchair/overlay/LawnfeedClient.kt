...
import me.lal.lawnchair.launcherclient.ILauncherClientProxy
...
class LawnfeedClient(private val launcher: me.lal.lawnchair.Launcher) : ILauncherClient {
    ...
    companion object {
        const val PROXY_PACKAGE = "me.lal.lawnchair.lawnfeed"
