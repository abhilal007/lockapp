...
package me.lal.wallpaperpicker;
...
import me.lal.wallpaperpicker.common.DialogUtils;
import me.lal.wallpaperpicker.common.InputStreamProvider;
import me.lal.wallpaperpicker.common.Utils;
import me.lal.wallpaperpicker.views.TiledImageRenderer;
import me.lal.lawnchair.R;
import me.lal.wallpaperpicker.BitmapRegionTileSource.BitmapSource;
import me.lal.wallpaperpicker.BitmapRegionTileSource.BitmapSource.InBitmapProvider;
import me.lal.wallpaperpicker.common.CropAndSetWallpaperTask;
import me.lal.wallpaperpicker.common.DialogUtils;
import me.lal.wallpaperpicker.common.InputStreamProvider;
import me.lal.wallpaperpicker.common.Utils;
import me.lal.wallpaperpicker.views.TiledImageRenderer.TileSource;
import me.lal.wallpaperpicker.common.CropAndSetWallpaperTask;
import me.lal.wallpaperpicker.common.DialogUtils;
import me.lal.wallpaperpicker.common.InputStreamProvider;
import me.lal.wallpaperpicker.views.TiledImageRenderer;
...
public class WallpaperCropActivity extends Activity implements Handler.Callback {
    ...
    public boolean handleMessage(Message msg) {
        if (msg.what == MSG_LOAD_IMAGE) {
            ...
            if (req.src == null) {
                ...
                loadSuccess = req.src.getLoadingState() == BitmapRegionTileSource.BitmapSource.State.LOADED;
            }
    ...
    private void addReusableBitmap(TiledImageRenderer.TileSource src) {
        synchronized (mReusableBitmaps) {
    ...
    protected void onLoadRequestComplete(LoadRequest req, boolean success) {
        ...
        if (success) {
            ...
            if (req.scaleAndOffsetProvider != null) {
                TiledImageRenderer.TileSource src = req.result;
